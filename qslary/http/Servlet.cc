...
int32_t FunctionServlet::handle(qslary::http::HttpRequest::ptr request, qslary::http::HttpResponse::ptr response,
...
int32_t ServletDispatch::handle(qslary::http::HttpRequest::ptr request, qslary::http::HttpResponse::ptr response,
                       qslary::http::HttpSession::ptr session)
{
...
int32_t NotFoundServlet::handle(qslary::http::HttpRequest::ptr request, qslary::http::HttpResponse::ptr response,
                                qslary::http::HttpSession::ptr session)
{
