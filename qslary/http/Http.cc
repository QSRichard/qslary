...
HttpRequest::HttpRequest() : method_(HttpMethod::GET), status_(HttpStatus::OK), mVersion("1.1"), close_(true), path_("/")
{
}

HttpRequest::HttpRequest(const HttpMethod& method, const HttpStatus& status, const std::string& version, bool close)
...
HttpResponse::HttpResponse() : status_(HttpStatus::OK), mVersion("1.1"), close_(true) {}

HttpResponse::HttpResponse(const HttpStatus& status, const std::string& version, bool close)
