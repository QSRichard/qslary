...
namespace http
{
HttpServer::HttpServer(bool keepAlive, qslary::IOManager* work, IOManager* accept_worker)
...
void HttpServer::handleClient(Socket::ptr client)
{
  ...
  {
    number++;
    std::cout << std::endl << "number = " << number << std::endl << std::endl;
    HttpRequest::ptr t;
    ...
    HttpResponse::ptr response(
        new HttpResponse(HttpStatus::OK, request->getVersion(), request->isClose() || !keepAlive_));
