...
public:
  ...
  virtual int32_t handle(qslary::http::HttpRequest::ptr request, qslary::http::HttpResponse::ptr response,
...
public:
  ...
  typedef std::function<int32_t(qslary::http::HttpRequest::ptr, qslary::http::HttpResponse::ptr,
