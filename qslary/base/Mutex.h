...
public:
    ...
    void assignHolder() { m_holder = CurrentThread::tid(); }

    void unassignHolder() { m_holder = 0; }
...
private:
    ...
    public:
        ...
        ~UnassignGuard() { m_owner.assignHolder(); }
...
public:
    ...
    void wlock() { pthread_rwlock_wrlock(&rwlock_); }
...
public:
    MutexLockGuard(MutexLock &lock) : m_mutex(lock) { m_mutex.lock(); }
