...
inline bool is_hook_enable() { return thread_hook_enable; }
inline void set_hook_enable(bool flag) { thread_hook_enable = flag; }
...
extern "C"
{
    ...
    typedef int (*nanaosleep_fun)(const struct timespec *reg,
                                  struct timespec *rem);
